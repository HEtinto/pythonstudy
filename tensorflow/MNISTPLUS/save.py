...
def main(args):
    ...
    print(eval_results)
    """
    input_receiver_fn_map = tf.estimator.ModeKeys
    mnist_classifier.export_saved_model(
        "C:/Users/Y2469/Desktop/pythonstudy/tensorflow/MNISTPLUS/saveModel",
        tf.estimator.ModeKeys, assets_extra=None, as_text=False,
        checkpoint_path=None, experimental_mode=tf.estimator.ModeKeys.PREDICT
    )
    """
    """
    feature_spec = {'foo': tf.io.FixedLenFeature(...),
                    'bar': tf.io.VarLenFeature(...)}
    ...
    mnist_classifier.export_saved_model(
        "C:/Users/Y2469/Desktop/pythonstudy/tensorflow/MNISTPLUS/saveModel",
        serving_input_receiver_fn, assets_extra=None, as_text=False,
